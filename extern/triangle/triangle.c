...
void init_triangulateio(struct triangulateio *obj)
{
	obj->pointlist = (REAL *)NULL;	
	obj->pointattributelist = (REAL *)NULL;
	obj->pointmarkerlist = (int *)NULL;
	obj->numberofpoints = 0;
	obj->numberofpointattributes = 0;

	obj->trianglelist = (int *)NULL;	
	obj->triangleattributelist = (REAL *)NULL;
	obj->trianglearealist = (REAL *)NULL;
	obj->neighborlist = (int *)NULL;
	obj->numberoftriangles = 0;
	obj->numberofcorners = 0;
	obj->numberoftriangleattributes = 0;
	
	obj->segmentlist = (int *)NULL;	
	obj->segmentmarkerlist = (int *)NULL;
	obj->numberofsegments = 0;

	obj->holelist = (REAL *)NULL;
	obj->numberofholes = 0;

	obj->regionlist = (REAL *)NULL;
	obj->numberofregions = 0;

	obj->edgelist = (int *)NULL;
	obj->edgemarkerlist = (int *)NULL;
	obj->normlist = (REAL *)NULL;
	obj->numberofedges = 0;
}

void free_triangulateio(struct triangulateio *obj)
{
	free(obj->pointlist);
	free(obj->pointattributelist);
	free(obj->pointmarkerlist);

	free(obj->trianglelist);
	free(obj->triangleattributelist);
	free(obj->trianglearealist);
	free(obj->neighborlist);

	free(obj->segmentlist);
	free(obj->segmentmarkerlist);

	free(obj->holelist);
	free(obj->regionlist);

	free(obj->edgelist);
	free(obj->edgemarkerlist);
	free(obj->normlist);
}
